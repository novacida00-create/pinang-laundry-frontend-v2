...
const allServices = [
  ...
  { icon: "yarn", name: "Cuci Karpet", price: "Rp 50.000/pcs", waktu: "2 hari", desc: "Cuci karpet besar dan tebal" },
...
const styles = {
  ...
  navContent: { maxWidth: 1200, margin: "0 auto", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "nowrap" },
  navLogo: { display: "flex", alignItems: "center", gap: 12, cursor: "default", flexShrink: 0 },
  navLogoIcon: { fontSize: 32 },
  navLogoText: { display: "block", fontSize: 20, fontWeight: 800, color: "#1e40af", whiteSpace: "nowrap" },
  navLogoSub: { display: "block", fontSize: 11, color: "#94a3b8", whiteSpace: "nowrap" },
  navLinks: { display: "flex", gap: 8, flexShrink: 0 },
  ...
  navButtons: { display: "flex", gap: 12, flexShrink: 0, whiteSpace: "nowrap" },
