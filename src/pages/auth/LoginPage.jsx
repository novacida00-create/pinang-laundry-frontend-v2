...
const styles = {
  ...
  cardRight: { flex: 1, padding: "40px 36px", display: "flex", flexDirection: "column", gap: 12, textAlign: "left" },
  ...
  label: { fontSize: 14, fontWeight: 400, color: "#475569", letterSpacing: "+0.3px", textAlign: "left" },
  input: { width: "100%", padding: "14px 16px", borderRadius: 14, border: "1px solid #e2e8f0", fontSize: 16, outline: "none", background: "#f8fafc", boxSizing: "border-box", lineHeight: 1.65, textAlign: "left" },
